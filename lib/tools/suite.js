...
function attachSuiteToObservable(suite, observable, started, reporter) {
    let state = undefined;
    ...
    processFeatures(features, started, reporter);
    return reporter;
}
...
class TestSuite {
    ...
    watch (observable, started) {

        let reporter = new Reporter();
        attachSuiteToObservable(this.features, observable, started, reporter);
